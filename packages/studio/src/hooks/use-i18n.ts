...
const strings = {
  // Header
  "nav.books": { zh: "书籍", ko: "작품", en: "Books" },
  "nav.newBook": { zh: "新建书籍", ko: "새 작품 만들기", en: "New Book" },
  ...
  "dash.noBooks": { zh: "还没有书", ko: "아직 작품이 없습니다", en: "No books yet" },
...
const koreanOverrides: Readonly<Record<string, string>> = {
  "dash.title": "작품 목록",
  "dash.createFirst": "첫 작품을 만들어 글쓰기를 시작하세요",
  ...
  "book.analytics": "분석",
  "book.noChapters": "아직 회차가 없습니다. ‘다음 화 쓰기’를 눌러 시작하세요",
  "book.approve": "승인",
  "book.reject": "반려",
  "book.words": "자",
  ...
  "reader.approve": "승인",
  "reader.reject": "반려",
  "reader.chapterList": "회차 목록",
  "reader.characters": "자",
  "reader.edit": "편집",
  "reader.preview": "미리보기",
  "reader.workspace": "회차 작업대",
  "reader.workspaceHint": "이 회차에 집필 지시가 계속 적용됩니다. 다시 쓸 때 현재 버전을 먼저 보관합니다.",
  "reader.chapterBrief": "회차 집필 지시",
  "reader.chapterBriefPlaceholder": "무엇을 유지하고, 무엇을 고치며, 어떤 사실을 바꾸면 안 되는지 적으세요.",
  "reader.saveBrief": "집필 지시 저장",
  "reader.rewriteFromBrief": "집필 지시대로 다시 쓰기",
  "reader.rewriting": "다시 쓰는 중...",
  "reader.inspiration": "영감 뽑기",
  "reader.drawing": "뽑는 중...",
  "reader.addToBrief": "집필 지시에 추가",
  "reader.generatedPlan": "생성된 회차 계획 보기",
  "reader.noPlan": "이 회차에 저장된 시스템 계획이 없습니다.",
  ...
  "reader.deleteChapter": "이 회차 삭제",
  "reader.deleteChapterConfirm": "최신 회차만 삭제할 수 있습니다. 삭제하고 이전 회차 상태로 되돌릴까요?",
  "reader.saved": "저장됨",
  ...
  "create.bookTitle": "제목",
  "create.language": "언어",
  "create.wordsPerChapter": "회차당 글자 수",
  "create.targetChapters": "목표 회차 수",
  ...
  "analytics.title": "분석",
  "analytics.totalChapters": "전체 회차",
  "analytics.totalWords": "전체 글자 수",
  "analytics.avgWords": "회차당 평균 글자 수",
  "analytics.statusDist": "상태 분포",
  "bread.books": "작품",
  "bread.newBook": "새 작품 만들기",
  "bread.config": "설정",
  "bread.chapter": "{n}화",
  "bread.film": "스토리 트리",
  ...
  "book.confirmDelete": "이 작품과 모든 회차를 삭제할까요?",
  "book.settings": "작품 설정",
  "book.status": "상태",
  ...
  "import.spinoffHint": "기존 작품을 정본으로 선택하면 인물과 세계관을 이어받되 본편 밖의 독립적인 외전 작품을 만듭니다.",
  "import.spinoffTitle": "외전 제목",
  "import.selectParent": "정본 작품 선택...",
  "import.spinoffDirection": "외전 방향(선택): 집중할 캐릭터·서브플롯·가정...",
  "import.spinoffDone": "외전이 만들어졌습니다",
  "import.imitation": "문체 모사 창작",
  "import.imitationHint": "참고 작품 원문과 새 이야기 개요를 입력하면 해당 문체를 참고한 새 작품을 만듭니다.",
  "import.imitationTitle": "새 작품 제목",
  "import.imitationIdea": "새로 만들 이야기의 개요...",
  "import.imitationRef": "참고 작품 텍스트를 붙여 넣으세요(문체만 참고하고 줄거리는 복사하지 않음)...",
  "import.imitationDone": "문체 모사 작품이 만들어졌습니다",
  "radar.title": "시장 레이더",
  "radar.scan": "시장 스캔",
  "radar.scanning": "스캔 중...",
  "radar.summary": "시장 요약",
  ...
  "genre.chapterTypes": "회차 유형",
  "genre.fatigueWords": "상투 표현",
  ...
  "settings.globalDefaultModelHint": "대화·작품 작업·CLI에서 모델을 따로 지정하지 않을 때 사용할 서비스와 모델입니다.",
