...
- 以近期章节为诊断窗口，让配对双方的有效互动、独处后的后效或关系选择持续可见；不把每章同场变成配额
...
- 语癖保留检查：即使 OOC，说话方式是否还有原作特征？`,
  ...
  cp: `- CP 近期窗口检查：最近几章里，有效互动、分开后的后效或关系选择是否持续可见？不要把本章同场或推进当成硬指标。
- 本章功能检查：若双方本章不同场，是否有来自关系的后果、选择或合理的个体任务？若有互动，是否产生化学反应而不是各干各的？`,
};
