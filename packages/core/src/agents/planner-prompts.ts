...
${webnovelPlanGuidance("chapter")}

## 기획 원칙

- 이번 화의 중심은 주인공이 끝내려는 일 또는 앞선 성취를 즐기고 정착시키는 역할입니다. 조사한다, 설득한다, 빼앗는다, 막는다처럼 결과를 확인할 수 있는 동사를 씁니다.
...
- 이번 화의 중심을 분명히 하고 필요한 보조 줄기만 둡니다. 줄기 수를 채우려고 장면을 만들지 않습니다.
...
## 현재 작업
주인공이 이번 화에 할 일 또는 성취를 누리는 역할. 상위 목적과의 연결 및 인물·장소·시점·이유·방법 중 이번에 필요한 내용을 짧게 덧붙이기
...
## 화말에 반드시 바뀔 것
- 실제로 달라질 정보·자원·관계·생활 또는 이미 얻은 성취를 누리고 유지하는 끝 상태. 개수 할당 없음
