      ...
      return textResult(
        [
          ...
          ...results.flatMap((result, index) => [
            ...
            `- span: UTF-16 [${result.charStart}, ${result.charEnd}); UTF-8 bytes [${result.byteStart}, ${result.byteEnd})`,
            `- archived_markdown_sha256: ${result.markdownSha256}`,
            `- excerpt_sha256: ${result.excerptSha256}`,
