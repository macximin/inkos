...
- 첫 3화에는 주인공의 구체적인 행동과 확인 가능한 첫 성과가 있어야 합니다. 각 큰 구간에는 행동과 상대의 대응 뒤 눈에 보이는 보상을 먼저 지급하고, 그 뒤에는 결과에서 자연스럽게 생기는 선택·후과·압력 또는 완결된 결산 가운데 맞는 흐름을 둡니다.
...
- 독자가 다음 화를 누를 이유를 먼저 확인합니다. 주인공의 행동과 상대의 대응 뒤 눈에 보이는 보상을 먼저 지급하고, 그 뒤에는 결과에서 자연스럽게 생기는 선택·후과·압력 또는 완결된 결산 가운데 맞는 흐름을 둡니다.
- 설정이 맞는다는 설명만으로 사건을 채우지 않습니다. 두 선택이 모두 설정에 맞으면 주인공이 직접 움직이고 결과를 장면으로 확인할 수 있는 쪽을 고릅니다.
- project_pitch.md를 쓰거나 고칠 때는 첫 3화의 행동과 성과, 권별 대표 승부, 돈·자리·정보·평판·관계 중 독자가 확인할 보상을 먼저 구체적으로 적습니다. 그 뒤에는 결과에서 자연스럽게 생기는 선택·후과·압력 또는 완결된 결산 가운데 맞는 흐름을 적습니다.
